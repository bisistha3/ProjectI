<?php
/**
 * HealthFlow — Goal Calculator Helper
 * Shared by register.php, settings.php and the JS goal calculator (mirror).
 */

/**
 * Daily water goal from BMI formula (weight × multiplier, gender + activity adjusted).
 */
...
/**
 * Calorie + macro targets from TDEE.
 * Split: 25% protein, 30% fat, 45% carbs of total energy.
 * Returns [calories, protein_g, fat_g, carbs_g], each rounded to nearest 5 and clamped.
 */
